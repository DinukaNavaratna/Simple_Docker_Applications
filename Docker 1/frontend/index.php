...
?>
    ...
    <div class="slider-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h4>Brands and shops that use <span>Docker</span> to grow their business</h4>
    ...
    <div id="features" class="cards-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="h2-heading">How to work with Docker?</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Get a head start on your coding by leveraging Docker images to efficiently develop your own unique applications on Windows and Mac. Create your multi-container application using Docker Compose.</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Leverage Docker Trusted Content, including Docker Official Images and images from Docker Verified Publishers from the Docker Hub repository.</p>
                        </div>
                    </div>
                    <!-- end of card -->
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="intro">
                        ...
                        <p>Below are some external articles shown inside a frame within this application.</p>
                    </div> <!-- end of intro -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="text-container">
                        <div class="section-title">IBM</div>
                        <h2>What is Docker? IBM Cloud Education</h2>
                        <p>Docker is an open source platform for building, deploying, and managing containerized applications. Learn about containers, how they compare to VMs, and why Docker is so widely adopted and used.</p>
                        <a class="btn-solid-reg" href="article.php?id=1">Show Article</a>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <h2>Docker (software) - Wikipedia</h2>
                        ...
                        <a class="btn-solid-reg" href="article.php?id=2">Show Article</a>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-7">
                    <div class="image-container">
    ...
    <div class="basic-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="text-container">
                        <div class="section-title">InfoWorld.com</div>
                        <h2>What is Docker? - InfoWorld</h2>
                        <p>Docker helps developers build lightweight and portable software containers that simplify application development, testing, and deployment.</p>
                        <a class="btn-solid-reg" href="article.php?id=3">Show Article</a>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
